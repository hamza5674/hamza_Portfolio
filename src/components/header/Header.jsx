            ...
            <div id='header ' className='bg-[#f5df4e] px-12 '>
                <div className='grid grid-cols-1 lg:grid-cols-2 py-[60px] gap-20 '>
                    ...
                    <div className='mt-10 md:mt-20 mx-auto lg:mx-0'>
                        <p className='text-[48px]  text-[#252b33] mb-2'>HI, I'M A FREELANCER</p>
                        <div>
                            <h1 className='text-[70px] md:text-[100px] lg:text-[115px] font-semibold  text-[#252b33] '>
                                <Typewriter
                                    options={{
                        ...
                        <div className='flex gap-3 items-center'>
                            ...
                            <div>
                                <a href="#" className='cursor-pointer  mt-7 text-[16px] px-10 py-3 inline-block underline hover:no-underline'>Contact Me</a>
                            </div>
                        </div>
                    </div>
